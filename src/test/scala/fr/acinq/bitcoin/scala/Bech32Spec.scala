...
class Bech32Spec extends FunSuite {
  ...
  test("encode and decode BIP86 taproot addresses") {
    val script = Script.parse(hex"5120eceb3f3cdbad5bda395a32910ff6195a89cc5ec7fbf34705512da6f81963b156")
    val witnessProgram = script(1).asInstanceOf[OP_PUSHDATA].data
    assert(Bech32.encodeWitnessAddress("bcrt", 1, witnessProgram) == "bcrt1pan4n70xm44da5w26x2gslaset2yuchk8l0e5wp239kn0sxtrk9tql9wc8z")
  }
}
