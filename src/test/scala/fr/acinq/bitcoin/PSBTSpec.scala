...
class PSBTSpec extends FlatSpec{
  ...
  it should "fail to deserialize invalid PSBTs" in {
    ...
    val weirdPSBT = PSBT.read64(invalidPSBT4)
    println(s"asd")


    assert(Try(PSBT.read64(invalidPSBT4)).isFailure)
  }
